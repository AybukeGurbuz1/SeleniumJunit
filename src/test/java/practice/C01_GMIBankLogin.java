...
public class C01_GMIBankLogin {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.cssSelector("#username")).sendKeys("Batch81");  // css daha hızlı daha sade
        driver.findElement(By.cssSelector("#password")).sendKeys("Batch81+", Keys.ENTER); // sonuna click de eklenebilir, enter ile girdik
